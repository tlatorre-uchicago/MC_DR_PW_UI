...
QT_MOC_LITERAL(1, 11, 11), // "vg3_1_chang"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 3), // "val"
QT_MOC_LITERAL(4, 28, 16), // "sendDataToClient"
QT_MOC_LITERAL(5, 45, 4) // "data"

    },
    "socket_com\0vg3_1_chang\0\0val\0"
    "sendDataToClient\0data"
};
...
void socket_com::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->vg3_1_chang((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 1: _t->sendDataToClient((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (socket_com::*)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&socket_com::vg3_1_chang)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void socket_com::vg3_1_chang(double _t1)
{
